    ...
    $(document).ready(function() {
        var analytics = {
            ...
            init: function() {
                ...
                var promoId = analytics.tools.get_url_param('promoId') ? '&promoId=' + analytics.tools.get_url_param('promoId') : '';
                ...
                analytics.settings.pages = {
                    ...
                    leadform: {
                        ...
                        form_name: 'lead form',
                        json: '/store/cart/leadTrackingJson.jsp' + eoId + promoId
                    },
                    student: {
                        form_steps: [
                            {
                        ...
                        form_name: 'student',
                        json: '/store/cart/leadTrackingJson.jsp?eoId='+$('body').data('eoid') + promoId
                    },
                };
                ...
                if (typeof(analytics.settings.path[0]) == 'undefined') {
                    analytics.settings.path = ['home-page'];
                }
                                ...
                                if (typeof(utag) !== 'undefined' && utag.hasOwnProperty('view')) {
                                    ...
                                    if (analytics.settings.retry_tealium_failure) {
                                        ...
                                        if (analytics.settings.retry_count <= analytics.settings.retry_limit) {
                                            ...
                                            analytics.log('Analytics: Goodbye. (âœ–â•­â•®âœ–)');
                                        }
                                    }
                                }
                            })
            ...
            tealium: {
                ...
                get_profile: function() {
                    ...
                    if (localStorage.getItem('tealium-profile')) { analytics.settings.tealium_profile = localStorage.getItem('tealium-profile'); }
            ...
            cart: {
                ...
                add_product: function(service) {
                        ...
                        $(service).each(function(i,v) {
                            ...
                            analytics.settings.product_string.product_credit.push(o.product_credit);
                    ...
                    if (analytics.settings.is_thanks && Object.keys(analytics.settings.stored_products).length > 0) {
                        ...
                        analytics.cart.get_json(analytics.settings.product_json_url).done(function(json) {
                            ...
                            $(analytics.settings.cart).each(function(i,o) {
                                ...
                                if (o.hasOwnProperty('simplePromotion')) {
                                    var promo_product = {
                                        name: o.simplePromotion.promoName,
                                        offerId: o.simplePromotion.promoId,
                                        quantity: 1,
                                        product_type: 'Promo',
                                        regularPrice: false,
                                        product_credit: o.simplePromotion.promoValue,
                                        regularPriceLessRecurringDiscount: false,
                                        recurringDiscount: false,
                                        monthlyRecurringRevenue: false,
                                        offerDiscount: false,
                                        orderType: o.formObjective.toLowerCase(),
                                        rguFlag: false,
                                        contract: false,
                                    };
                                    analytics.cart.add_product(promo_product);
                                }
